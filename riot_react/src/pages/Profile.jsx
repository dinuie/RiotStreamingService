...
const ProfilePage = () => {
    ...
    return (
        <div className="h-screen flex flex-col">
            ...
            <div
                className="bg-gradient-to-br from-purple-900 to-pink-500 min-h-screen bg-center bg-fixed h-screen flex-col justify-center items-center text-center text-white bg-cover">
                <div className="">
                    {Array(4)
                        .fill()
                        .map((_, index) => (
                    ...
                    <p className="mb-4">
                        ...
                        <input
                            type="text"
                            value={user.username}
                            className="bg-transparent text-white mx-2 text-center"
                        />
                    </p>
                    <p className="mb-4">
                        Date of Birth:
