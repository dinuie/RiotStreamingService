...
const ProfilePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.message === "Your password is updated") {
        ...
        notification.error({
          description:
            "The password you entered doesn't match your current one.",
        });
      }
    } catch (error) {
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      {isLoggedIn && (
        <div className="min-h-screen bg-center bg-fixed h-screen flex-col justify-center items-center text-center text-white bg-cover bg-no-repeat">
          <div className="">
            {Array(4)
              .fill()
              .map((_, index) => (
